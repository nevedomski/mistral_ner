...
def main() -> None:
    ...
    parser.add_argument(
        "--wandb-dir", type=str, default="./wandb", help="Directory containing offline WandB runs (default: ./wandb)"
    )
    parser.add_argument("--list", action="store_true", help="List all offline runs without syncing")
    parser.add_argument("--run-id", type=str, help="Sync specific run by ID (e.g., offline-run-20231120_123456-abc123)")
